...
namespace board {
    ...
    public:
        ...
        // Calculates the number of squares until the edge of the boardin all eight directions.
        // Returns a 2d vector containing a struct holding the number of squares until the edge
    ...
    private:
        ...
        vector< moveStruct > generatePromotionOptions(int beginRank, int beginFile, int endRank, int endFile);
